...
//create a function, simple parameter
//function should have two paramaters, numberOne and numberTwo

const simpleSum = (numberOne, numberTwo) =>{
  //function sums the arguments passed through function simpleSum
  return numberOne + numberTwo;
}


//console.log(simpleSum(3,4));//-->7
//instructions
describe('simpleSum', () => {
